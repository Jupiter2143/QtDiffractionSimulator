...
void MainWindow::initConnect()
{
    ...
    connect(ui->graphicsView, &MyGraphicsView::status, this, &MainWindow::updateStatusBar);
}
...
void MainWindow::updateUI(QImage *image)
{
    ...
    ui->plainTextEdit->appendPlainText(QString("Cost: %1 s").arg(elapsed_seconds.count()));
...
void MainWindow::on_scaleBox_customContextMenuRequested(const QPoint &pos)
{
